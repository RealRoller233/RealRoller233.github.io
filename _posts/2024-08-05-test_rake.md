...
![这里是图片的描述文字]({{ site.baseurl }}/assets/images/my-cool-photo.jpg)
![2024-07-21_15-11.png](img/2024-07-21_15-11.png)
![2024-07-21_15-11_1.png](img/2024-07-21_15-11_1.png)
![2024-07-21_15-12.png](img/2024-07-21_15-12.png)
然后重新打包
输入
```bash
...
```
![2024-07-21_15-53 1.png](img/'2024-07-21_15-53 1.png')
之后校验一下
```bash
...
```
![2024-07-21_15-55.png](img/2024-07-21_15-55.png)
之后断电重启
进入windows操作系统，将电脑有线网卡IP设置为192.168.1.254
打开tfptd,将recovery文件版本号去掉，放在tftpd所在文件夹中，之后打开tftpd，有如图显示则成功
![屏幕截图 2024-07-21 081320.png](img/'屏幕截图 2024-07-21 081320.png')
![屏幕截图 2024-07-21 081401.png](img/'屏幕截图 2024-07-21 081401.png')![屏幕截图 2024-07-21 082824.png](img/'屏幕截图 2024-07-21 082824.png')
之后重启路由器，浏览器登陆192.168.1.1,上传sysupgrade固件，之后大功告成
![IMG_9982.png](img/IMG_9982.png)
![IMG_0327.png](img/IMG_0327.png)
